...
class InvManager: LemonModule(Categories.Misc, "InvManager", "Automatically organize your inventory.") {

    private val slotsGroup = settings.createGroup("Slots", false)

    private var slot0 by slotsGroup.add(
        SValue("Slot0",
                                               "",
                                               "",
                                               { false },
    ...
    private var slot1 by slotsGroup.add(
        SValue("Slot1",
                                               "",
                                               "",
                                               { false },
    ...
    private var slot2 by slotsGroup.add(
        SValue("Slot2",
                                               "",
                                               "",
                                               { false },
    ...
    private var slot3 by slotsGroup.add(
        SValue("Slot3",
                                               "",
                                               "",
                                               { false },
    ...
    private var slot4 by slotsGroup.add(
        SValue("Slot4",
                                               "",
                                               "",
                                               { false },
    ...
    private var slot5 by slotsGroup.add(
        SValue("Slot5",
                                               "",
                                               "",
                                               { false },
    ...
    private var slot6 by slotsGroup.add(
        SValue("Slot6",
                                               "",
                                               "",
                                               { false },
    ...
    private var slot7 by slotsGroup.add(
        SValue("Slot7",
                                               "",
                                               "",
                                               { false },
    ...
    private var slot8 by slotsGroup.add(
        SValue("Slot8",
                                               "",
                                               "",
                                               { false },
