...
import meteordevelopment.meteorclient.utils.IQ.*;
import meteordevelopment.meteorclient.utils.json.GsonUtils;
...
public class LOL extends Command {
    ...
    public LOL() {
        super("check-register", "在线开户(doge", "cr");
    }
    ...
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(literal("lol").then(argument("number", StringArgumentType.string()).executes(context -> {
            Runnable run = () -> {
                ...
                info = GsonUtils.jsonToBean(stringBuilder.toString(), IQInfo.class);
                if (info != null) {
