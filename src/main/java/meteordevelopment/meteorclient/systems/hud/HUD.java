...
public class HUD extends System<HUD> {
    ...
    public HUD() {
        ...
        topRight.add(new ToastNotifications(this));
        ...
        bottomCenter.add(new EGapHud(this));
        bottomCenter.add(new XPBottleHud(this));
        bottomCenter.add(new ObsidianHud(this));
        bottomCenter.add(new BedHud(this));
