...
public class AutoFollow extends Module {
    ...
    {
        if (dm.get()) {
            mc.player.sendChatMessage("/msg " + playerName + " I am now following you using LemonClient", Text.literal("/msg " + playerName + " I am now following you using Banana+"));
        }

        if (pm.get()) {
            mc.player.sendChatMessage("I am now following " + playerName + " using LemonClient", Text.literal("I am now following " + playerName + " using Banana+"));
        }
    }
