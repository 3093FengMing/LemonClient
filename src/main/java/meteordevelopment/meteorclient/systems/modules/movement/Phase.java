...
import meteordevelopment.meteorclient.systems.modules.combat.LemonAuraPlus;
...
public class Phase extends Module {
    ...
    private final Setting<Double> clipDistance = sgGeneral.add(new DoubleSetting.Builder().name("Clip Distance").description("The distance per clip.").defaultValue(.01).min(0).max(1).visible(() -> mode.get() != Mode.Normal).build());
    public Phase() {
        super(Categories.Movement, "phase", "Lets you walk through blocks.");
    }
