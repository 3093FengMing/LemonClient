...
import meteordevelopment.meteorclient.utils.misc.Vec3dInfo;
...
import static meteordevelopment.meteorclient.utils.player.BedUtils.*;
...
public class BedBomb extends Module {
    ...
    public BedBomb() {
        super(Categories.Combat, "bed-bomb", ":massivetroll: owo");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (pauseOnCA.get() && (Modules.get().get(LemonAuraPlus.class).isActive() || Modules.get().get(LemonAura.class).isActive()))
            return;
