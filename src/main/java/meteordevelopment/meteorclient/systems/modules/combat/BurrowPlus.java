...
import static meteordevelopment.meteorclient.utils.world.BlockInfo.isReplaceable;
...
public class BurrowPlus extends Module {
    ...
    private final Setting<List<Block>> block = sgGeneral.add(new BlockListSetting.Builder().name("block").description("Which blocks used for burrow.").defaultValue(Collections.singletonList(Blocks.OBSIDIAN)).filter(this::blockFilter).build());
    ...
    public BurrowPlus() {
        super(Categories.Combat, "burrow-plus", "Clips you into a block.");
    }
