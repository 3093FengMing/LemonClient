...
import static meteordevelopment.meteorclient.utils.player.Interaction.doSwing;
import static meteordevelopment.meteorclient.utils.player.Interaction.hasEntity;
import static meteordevelopment.meteorclient.utils.render.NewRenderUtils.*;
import static meteordevelopment.meteorclient.utils.misc.Vec3dInfo.closestVec3d;
...
public class PistonAura extends Module {
    ...
    private final Setting<NewRenderUtils.RenderMode> renderMode = sgRender.add(new EnumSetting.Builder<NewRenderUtils.RenderMode>().name("render").description("How the render will work.").defaultValue(NewRenderUtils.RenderMode.Box).build());
