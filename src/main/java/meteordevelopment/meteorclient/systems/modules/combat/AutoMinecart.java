...
public class AutoMinecart extends Module {
    ...
    private final Setting<Boolean> rotate = sgDefault.add(new BoolSetting.Builder().name("rotate").description("Automatically faces towards the blocks being placed.").defaultValue(false).build());
    ...
    public AutoMinecart() {
        super(Categories.Combat, "auto-minecart", "Places and blow's up minecarts in the target.");
    }
