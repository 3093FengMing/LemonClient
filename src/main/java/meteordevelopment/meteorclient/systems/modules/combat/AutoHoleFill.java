...
import static meteordevelopment.meteorclient.utils.player.BedUtils.getTargetSphere;
...
public class AutoHoleFill extends Module {
    ...
    private final Setting<Boolean> doubles = sgGeneral.add(new BoolSetting.Builder().name("doubles").defaultValue(true).build());
    ...
    public AutoHoleFill() {
        super(Categories.Combat, "auto-hole-fill", "Automatically fills holes around target.");
    }
