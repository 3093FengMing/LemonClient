...
import meteordevelopment.meteorclient.systems.modules.player.XPThrower;
...
public class Offhand extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        // Crystals
        else if ((modules.isActive(LemonAura.class) && crystalCa.get() || modules.isActive(LemonAuraPlus.class) && crystalCa.get())
