...
import meteordevelopment.meteorclient.utils.world.BWorldUtils;
import meteordevelopment.meteorclient.utils.player.PositionUtils;
...
public class Surround extends Module {
    ...
    private final Setting<Boolean> AGB = sgPlacing.add(new BoolSetting.Builder()
        .name("anti-ghost-block")
        .description("Removing client-side surround blocks.")
        .defaultValue(true)
        .build());
