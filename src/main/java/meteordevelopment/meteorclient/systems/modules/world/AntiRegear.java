...
public class AntiRegear extends Module {
    ...
    public AntiRegear() {
        super(Categories.World, "anti-regear", "Automatically breaks shulkers and EChests which was placed by enemy.");
    }
    ...
    private final PacketUtils2 packetMine = new PacketUtils2();
