...
public class FacingSettings extends Module {
    public FacingSettings() {
        super(Categories.Settings, "Facing", "Global facing settings for every blackout module");
    }
        ...
        if (mc.world != null && mc.player != null) {
            if (airPlace.get()) {
                ...
                for (Direction dir : Direction.values()) {
                    ...
                    if (strictDir.get() && !LemonKUtils.strictDir(pos.offset(dir), dir.getOpposite())) {continue;}
    ...
    public Direction getPlaceOnDirection(BlockPos pos) {
        ...
        if (mc.world != null && mc.player != null) {
            ...
            for (Direction dir : Direction.values()) {
                ...
                if (strictDir.get() && !LemonKUtils.strictDir(pos, dir)) {continue;}
