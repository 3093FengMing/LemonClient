...
public class WLemonSection extends WSection {
    public WLemonSection(String title, boolean expanded, WWidget headerWidget) {
    ...
    protected static class WHeaderTriangle extends WTriangle implements LemonWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
