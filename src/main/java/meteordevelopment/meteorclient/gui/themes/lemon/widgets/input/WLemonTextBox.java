...
import meteordevelopment.meteorclient.gui.themes.lemon.widgets.WLemonLabel;
...
public class WLemonTextBox extends WTextBox implements LemonWidget {
    private boolean cursorVisible;
    private double cursorTimer;

    private double animProgress;

    public WLemonTextBox(String text, String placeholder, CharFilter filter, Class<? extends Renderer> renderer) {
    ...
    private static class CompletionItem extends WLemonLabel implements ICompletionItem {
