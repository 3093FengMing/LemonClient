    ...
    public static double possibleHealthReductions(boolean entities, boolean fall) {
        ...
        if (entities) {
            for (Entity entity : mc.world.getEntities()) {
                ...
                if (entity instanceof EndCrystalEntity && damageTaken < NewCrystalUtils.crystalDamage(mc.player, entity.getPos())) {
                    damageTaken = NewCrystalUtils.crystalDamage(mc.player, entity.getPos());
                }
